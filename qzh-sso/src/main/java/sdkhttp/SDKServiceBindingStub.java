...
public class SDKServiceBindingStub extends org.apache.axis.client.Stub implements SDKClient {
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {arg0, arg1, arg2});
  ...
  throw axisFaultException;
    ...
    public String yanzhengma(String phone) throws Exception {
		
    	java.net.URL endpointURL=new java.net.URL("http://sdkhttp.eucp.b2m.cn/sdk/SDKService?wsdl");
    	javax.xml.rpc.Service service=null;
    	SDKServiceBindingStub client=new SDKServiceBindingStub(endpointURL, service);
    	double blance=client.getBalance("3SDK-EMY-0130-PIWPL", "303116");
    	System.out.println("余额:"+blance);
    	// 取随机产生的认证码(4位数字)
    	String rand = QzhFunc.int2str(Math.random()*10000);
    	...
    	//sb.append("【调剂品商城】尊敬的用户:手机注册验证码:"+rand+"。请及时录入，完成注册！");
    	sb.append("【千纸鹤商城】尊敬的用户:手机注册验证码:"+rand+"。请及时录入，完成注册！");
    	System.out.println("mobile: "+phone);
    	int sendValue=	client.sendSMS("3SDK-EMY-0130-PIWPL", "303116", null, new String[]{phone}, sb.toString(), "", "GBK", 5, System.currentTimeMillis());
    ...
    public String sjdxtx(String content, String phone)throws Exception {
       	...
       	StringBuffer sb=new StringBuffer();
       	//sb.append("【调剂品商城】尊敬的用户:"+content);
       	sb.append("【千纸鹤商城】尊敬的用户:"+content+rand);
       	System.out.println("mobile: "+phone);
       	int sendValue=	client.sendSMS("3SDK-EMY-0130-PIWPL", "303116", null, new String[]{phone}, sb.toString(), "", "GBK", 5, System.currentTimeMillis());
       	System.out.println("发送内容:"+sb+"返回值:"+sendValue);
       	if(sendValue==0){
    ...
    public String priceInformation(String phone, String params) throws Exception {
